...
TEMPLATE_SOIL_PATH = "{local_path_to_data_dir}germany/MOL-buek-wr_100_25832_etrs89-utm32n.asc"
...
def write_row_to_grids(row_col_data, row, ncols, header, path_to_output_dir, path_to_csv_output_dir, setup_id):
    ...
    #     # "SWC_1": {"data": make_dict_nparr(), "cast-to": "float", "digits": 3}

    # }

    output_grids = {
        # "TimeUnderAnoxia": {"data": make_dict_nparr(), "cast-to": "float", "digits": 3},
        "avgAirFilledPoreVolume": {"data": make_dict_nparr(), "cast-to": "float", "digits": 3}
